    ...
    <section className="min-h-screen flex items-center justify-center bg-white px-4 py-12">
      <div className="w-full max-w-xl bg-gray-100 rounded-xl shadow-lg p-8 space-y-6">
        ...
        <form className="space-y-4">
          <div>
            <label htmlFor="ownerLastName" className="block mb-1 text-gray-700">
              Nom
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="telephone" className="block mb-1 text-gray-700">
              Téléphone
            </label>
            <input
              type="tel"
          ...
          <div>
            <label
              ...
              className="block mb-1 text-gray-700"
            >
              Durée de possession de l’animal
            </label>
            <input
              type="text"
